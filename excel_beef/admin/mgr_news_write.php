...
$sql = "select * from news where uid='$sid';";
...
<meta charset="UTF-8">
<title>게시판 작성</title>
<link rel="stylesheet" href="../css/mgr_news_write.css">
...
<h2>뉴스 게시글 작성</h2>
<form name="mgr_news_write" action="mgr_news_write_ok.php" method="post">
<fieldset>
...
<div>
<input type="READONLY " name="id" class="id" id="id" value="<?php echo $sid ?>"></div>
</li>
<li>  
