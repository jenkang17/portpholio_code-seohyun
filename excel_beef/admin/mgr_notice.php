...
<title>공지사항</title>
<link rel="stylesheet" type="text/css" href="../css/mgr_notice.css">
...
<li class="gm03"><a href="#">event and news</a></li>
...
<td><a href="../gnb/notice_sub.php?idx=<?php echo $array["idx"] ?>"><?php echo $array["title"]; ?></a></td>
<td><?php echo $array["uid"]; ?></td>
<td><?php echo $array["reg_date"]; ?></td>
<td><a href="mgr_notice_edit.php?idx=<?php echo $array["view"] ?>"></a></td>
<td class="edit_bt"><a href="mgr_notice_edit.php?idx=<?php echo $array["idx"] ?>">수정</a></td>
<td class="delete_bt"><a href="mgr_notice_delete.php?idx=<?php echo $array["idx"] ?>">삭제</a></td>
</tr>
<?php
$begin_num--;
}
...
<p>
<a class="write_bt" href="notice_write.php">게시글 작성</a>
