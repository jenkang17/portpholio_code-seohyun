...
<head>
	...
	<title>공지사항</title>
  <link rel="stylesheet" type="text/css" href="../css/notice_sub03.css">
</head>
<body>
  <div class="skip_menu">
		...
		<div id="header" class="header">
			...
			<div class="top_menu">
				<ul>
					...
					<li class="tm05"><a href="join.html">JOIN</a><p>3000point 적립</p></li>
				</ul>
			</div>
      ...
      <div class="content_wrap">
        ...
        <div class="notice">
          ...
          <div class="notice_content">
              <img src="images/notice_content03.jpg" alt="cj대한통운의 배송비 정책 변경으로 인해 기본 배송비가 인상됨을 알려드립니다. 기존 배송비 2,500원에서 3,000원으로 인상 됩니다.">
          </div>
          <a class="list_bt" href="notice.html">목록으로</a>
          <div class="notice_list">
            <ul class="next">
              <li>다음글</li>
              <li><a href="#none">다음 글 없음</a></li>
            </ul>
            <ul class="prev">
              <li>이전글</li>
