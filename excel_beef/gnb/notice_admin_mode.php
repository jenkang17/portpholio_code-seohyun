...
<tbody>
<?php $count_list = mysqli_num_rows($result); 
while($array = mysqli_fetch_array($result)){
?>
<tr>
<td><?php echo $array["idx"]; ?></td>
<td><a href="notice_sub01.php"><?php echo $array["title"]; ?></a></td>
...
<p>
<a class="edit_bt" href="notice_write.php?idx=<?php echo $array["idx"] ?>">게시글 작성</a>
</p>
</div>
</main>
